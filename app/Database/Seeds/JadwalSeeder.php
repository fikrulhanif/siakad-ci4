...
class JadwalSeeder extends Seeder
{
    public function run()
    {
        ...
        $matakuliah = $db->table('matakuliah')->orderBy('smt', 'ASC')->orderBy('kd_mk', 'ASC')->get()->getResultArray();
        ...
        foreach ($matakuliah as $mk) {
            ...
            if ($isPraktikum) {
                ...
                // Kelas B (hari yang sama, jam berbeda atau hari berbeda)
        ...
        echo "✅ Berhasil insert " . count($jadwal) . " jadwal\n";
    }
}
