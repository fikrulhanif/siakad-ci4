...
class JadwalGanjilSeeder extends Seeder
{
    public function run()
    {
        $nidn = '123'; // NIDN dosen default
        $id_tahun = 5; // ID tahun akademik GANJIL
        ...
        // Ambil mata kuliah SEMESTER GANJIL (1, 3, 5, 7)
        ...
        echo "✅ Berhasil insert " . count($jadwal) . " jadwal untuk SEMESTER GANJIL (1, 3, 5, 7)\n";
    }
}
