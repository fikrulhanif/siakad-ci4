...
<section class="content-header">
    <h1><i class="fa fa-calendar"></i> Laporan Jadwal Perkuliahan</h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <form action="<?= site_url('admin/laporan/preview-jadwal') ?>" method="POST">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">Pilih prodi untuk filter jadwal sesuai kurikulum</small>
                        </div>
                    </div>
