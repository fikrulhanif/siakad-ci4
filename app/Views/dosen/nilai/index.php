...
<section class="content-header">
    <h1><i class="fa fa-edit"></i> Input Nilai Mahasiswa</h1>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="info-box shadow" style="min-height: 100px; background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%);">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <div style="margin-top: 5px;">
                                        <span class="badge bg-gray"><i class="fa fa-code"></i> <?= $j['kd_mk'] ?></span>
                                    ...
                                    <div style="margin-top: 8px;">
                                        <a href="<?= site_url('dosen/nilai/input/'.$j['id_jadwal']) ?>" class="btn btn-success btn-xs">
                                            <i class="fa fa-edit"></i> Mulai Input Nilai
                                        </a>
                                    </div>
                                </div>
                            </div>
